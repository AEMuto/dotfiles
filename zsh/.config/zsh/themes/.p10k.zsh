# Generated by Powerlevel10k configuration wizard on 2024-07-02 at 11:03 CEST.
...
#
#   for i in {0..'#CAD3F5'}; do print -Pn "%K{$i}  %k%F{$i}${(l:3::0:)i}%f " ${${(M)$((i%6)):#3}:+$'\n'}; done
...
() {
  ...
  # typeset -g POWERLEVEL9K_TERM_SHELL_INTEGRATION=true # Enable Powerlevel10k zsh integration.   
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#8AADF4'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#C6A0F6'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#24273A'
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_SHORTENED_FOREGROUND='#A5ADCB'
  #   typeset -g POWERLEVEL9K_DIR_WORK_ANCHOR_FOREGROUND='#CAD3F5'
  #
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_NOT_WRITABLE_SHORTENED_FOREGROUND='#A5ADCB'
  #   typeset -g POWERLEVEL9K_DIR_WORK_NOT_WRITABLE_ANCHOR_FOREGROUND='#CAD3F5'
  #
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_NON_EXISTENT_SHORTENED_FOREGROUND='#A5ADCB'
  #   typeset -g POWERLEVEL9K_DIR_WORK_NON_EXISTENT_ANCHOR_FOREGROUND='#CAD3F5'
  #
  ...
  ###########[ timewarrior: timewarrior tracking status (https://timewarrior.net/) ]############
  # Timewarrior color.
  typeset -g POWERLEVEL9K_TIMEWARRIOR_FOREGROUND='#CAD3F5'
  ...
  #######################[ go_version: go version (https://golang.org) ]########################
  # Go version color.
  typeset -g POWERLEVEL9K_GO_VERSION_FOREGROUND='#CAD3F5'
  ...
  function p10k-on-post-prompt() { 
    p10k display '1|2/(left_frame|right_frame)|2/right/(ip|public_ip|proxy|battery|wifi)'=hide
  }

  function p10k-on-pre-prompt() { 
    p10k display '1|2/(left_frame|right_frame)|2/right/(ip|public_ip|proxy|battery|wifi)'=show
  }
